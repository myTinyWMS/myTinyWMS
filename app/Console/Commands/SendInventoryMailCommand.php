...
class SendInventoryMailCommand extends Command
{
    ...
    public function handle() {
        ...
        Mail::to('mail@example.com')->cc('mail@example.com')->cc('mail@example.com')->send(new InventoryMail($date, $excel, 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'inventory.xslx'));
    }
}
