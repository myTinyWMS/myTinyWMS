...
class ArticleDataTable extends BaseDataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            ['data' => 'min_quantity', 'name' => 'min_quantity', 'title' => 'Mind.<br/>Bestand', 'class' => 'text-center', 'width' => '40px'],
            ['data' => 'order_quantity', 'name' => 'order_quantity', 'title' => 'Bestell<br/>menge', 'class' => 'text-center', 'width' => '40px'],
