...
class UserSettings {
    ...
    const SETTING_NOTIFY_AFTER_NEW_DELIVERY_WITHOUT_INVOICE_RECEIVED = 'notify_after_new_delivery_without_invoice_received';
    ...
    const SETTINGS = [
        ...
        self::SETTING_NOTIFY_AFTER_NEW_DELIVERY_WITHOUT_INVOICE_RECEIVED => [
            'default' => false,
            'type' => 'boolean'
        ],
