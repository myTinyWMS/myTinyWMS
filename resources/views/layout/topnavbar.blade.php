            ...
            <div class="flex items-center">
                ...
                <dropdown direction="right">
                    <template v-slot:trigger>
                        <a class="count-info mr-8 relative text-gray-500 text-2xl" href="#">
                ...
                @can(['admin'])
                <a href="{{ route('admin.index') }}" class="text-gray-500" title="@lang('Administrator')"><i class="fa fa-cogs"></i></a>
                @endcan
