...
@section('datatableFilters')
    <label>
       Kategorie:&nbsp;
        <select id="filterCategory" data-target-col="16" class="form-control input-sm datatableFilter-select">
            <option value=""></option>
    ...
    <label>
        Tags:&nbsp;
        <select id="filterTags" data-target-col="15" class="form-control input-sm datatableFilter-select">
            <option value=""></option>
    ...
    <label>
       Lieferant:&nbsp;
        <select id="filterSupplier" data-target-col="13" class="form-control input-sm datatableFilter-select">
            <option value=""></option>
    ...
    <label>
       Status:&nbsp;
        <select id="filterStatus" data-target-col="17" class="form-control input-sm datatableFilter-select" data-pre-select="1">
