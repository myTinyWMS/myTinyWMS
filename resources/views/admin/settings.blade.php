    ...
    <div class="flex w-full items-start">
        <div class="card 2xl:w-1/3 w-1/2">
            <div class="card-header flex">
                <div class="flex-1">@lang('Ausgehende E-Mails')</div>
            </div>

            <div class="card-content">
                <div class="row">
                    <div class="w-full text-gray-600 text-sm pb-6">
        ...
        <div class="card 2xl:w-1/3 w-1/2 ml-4">
            <div class="card-header flex">
                <div class="flex-1">@lang('Import eingehender E-Mails für Bestellungen')</div>
            </div>
