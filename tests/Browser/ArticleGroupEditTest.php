    ...
    public function test_article_group_show_view_is_correct() {
        $this->browse(function (Browser $browser) {
            ...
            $browser
                ...
                ->assertSee($articleGroup->items[0]->article->internal_article_number)
                ->assertSee($articleGroup->items[1]->article->internal_article_number)
                ->assertSee($articleGroup->items[2]->article->internal_article_number)
    ...
    public function test_article_group_edit_form() {
        $this->browse(function (Browser $browser) {
            ...
            $browser
                ...
                ->type('.dataTables_filter input', $newArticle->internal_article_number)
                ->waitUntilMissing('#dataTableBuilder_processing')
                ->pause(1000)
                ->press('auswählen')
